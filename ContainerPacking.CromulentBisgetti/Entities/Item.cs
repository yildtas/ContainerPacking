...
namespace ContainerPacking.CromulentBisgetti.Entities
{
    /// <summary>
    ...
    public class Item
    {
        ...
        public Item(int id, decimal dim1, decimal dim2, decimal dim3, int quantity, bool isHub = false)
        {
            this.ID = id;
            this.Dim1 = dim1;
            this.Dim2 = dim2;
        ...
        /// <summary>
        /// This used for deserialize jsondata
        /// </summary>
        public Item()
        {
